...
[![Doc](https://img.shields.io/badge/doc-reference-blue.svg)](https://pkg.go.dev/github.com/vigilnetwork/vgl/math/uint256)
...
This package is part of the `github.com/vigilnetwork/vgl/math/uint256` module.  Use
the standard go tooling for working with modules to incorporate it.

## Examples

* [Basic Usage](https://pkg.go.dev/github.com/vigilnetwork/vgl/math/uint256#example-package-BasicUsage)  
