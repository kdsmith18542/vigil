...
// maxNetAddressPayload returns the max payload size for a Vigil NetAddress
...
type NetAddress struct {
	...
	// not present in the Vigil version message (MsgVersion) nor was it
...
func readNetAddress(r io.Reader, pver uint32, na *NetAddress, ts bool) error {
	...
	// NOTE: The Vigil protocol uses a uint32 for the timestamp so it will
...
func writeNetAddress(w io.Writer, pver uint32, na *NetAddress, ts bool) error {
	// NOTE: The Vigil protocol uses a uint32 for the timestamp so it will stop
