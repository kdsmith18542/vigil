...
// MsgGetData implements the Message interface and represents a vigil
...
// NewMsgGetData returns a new Vigil getdata message that conforms to the
...
// NewMsgGetDataSizeHint returns a new Vigil getdata message that conforms to
