...
// MsgBlock implements the Message interface and represents a Vigil
...
// BtcDecode decodes from the Vigil wire protocol as it was sent across the
...
// the Vigil wire protocol in order to be sent across the network.  The wire
...
// NewMsgBlock returns a new Vigil block message that conforms to the
