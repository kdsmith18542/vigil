...
// MsgInv implements the Message interface and represents a vigil inv message.
...
// NewMsgInv returns a new Vigil inv message that conforms to the Message
...
// NewMsgInvSizeHint returns a new Vigil inv message that conforms to the
