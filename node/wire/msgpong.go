...
// MsgPong implements the Message interface and represents a Vigil pong
// message which is used primarily to confirm that a connection is still valid
// in response to a Vigil ping message (MsgPing).
//
...
// NewMsgPong returns a new Vigil pong message that conforms to the Message
