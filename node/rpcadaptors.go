...
import (
	...
	"github.com/vigilnetwork/vgl/internal/mining/cpuminer"
	"github.com/vigilnetwork/vgl/internal/netsync"
	"github.com/vigilnetwork/vgl/internal/rpcserver"
...
// This function is safe for concurrent access and is part of the
// rpcserver.ConnManager interface implementation.
func (cm *rpcConnManager) RelayTransactions(txns []*VGLutil.Tx) {
...
// This function is safe for concurrent access and is part of the
// rpcserver.SyncManager interface implementation.
func (b *rpcSyncMgr) SubmitBlock(block *VGLutil.Block) error {
...
func (b *rpcSyncMgr) ProcessTransaction(tx *VGLutil.Tx, allowOrphans bool,
...
func (s *rpcSanityChecker) CheckBlockSanity(block *VGLutil.Block) error {
	_, err := s.chain.ProcessBlock(block)
	return err
}
