...
func TestNet3Params() *Params {
	// testNetPowLimit is the highest proof of work value a Vigil block
	...
	genesisBlock := wire.MsgBlock{
		Header: wire.BlockHeader{
			...
			Timestamp:    time.Unix(1678886400, 0), // 2023-03-15 00:00:00 +0000 UTC
	...
	return &Params{
		...
		Deployments: map[uint32][]ConsensusDeployment{
			...
			5: {{ // This is the KawPoW deployment, which is now at version 5
				Vote: Vote{
					Id:          VoteIDKawPoW,
			...
			6: {{ // This is the stake difficulty algorithm change, which is now at version 6
				Vote: Vote{
					...
					Description: "Change stake difficulty algorithm as defined in VGLP0001",
					Mask:        0x0006, // Bits 1 and 2
					Choices: []Choice{{
						Id:          "abstain",
			...
			7: {{ 
				Vote: Vote{ 
					...
					Choices: []Choice{{ 
						...
						Id: "no", 
						Description: "keep the existing proof of work algorithm", 
						Bits: 0x0002, // Bit 1 
						IsAbstain: false, 
						IsNo: true, 
					}, { 
						Id: "yes", 
						Description: "change to the new proof of work algorithm", 
						Bits: 0x0004, // Bit 2 
						IsAbstain: false, 
						IsNo: false, 
					}}, 
			...
			0: {{
				Vote: Vote{
					Id:          VoteIDLNFeatures,
					Description: "Enable features defined in VGLP0002 and VGLP0003 necessary to support Lightning Network (LN)",
					Mask:        0x0006, // Bits 1 and 2
					Choices: []Choice{{
						Id:          "abstain",
						Description: "abstain voting for change",
			...
			6: {{
				Vote: Vote{
					...
					Description: "Modify sequence lock handling as defined in VGLP0004",
					Mask:        0x0006, // Bits 1 and 2
					Choices: []Choice{{
						Id:          "abstain",
						Description: "abstain voting for change",
			...
			9: {{
				Vote: Vote{
					Id:          VoteIDTreasury,
					Description: "Enable decentralized Treasury opcodes as defined in VGLP0006",
					Mask:        0x0006, // Bits 1 and 2
					Choices: []Choice{{
						Id:          "abstain",
						Description: "abstain voting for change",
			...
			10: {{
				Vote: Vote{
					...
					Description: "Change maximum treasury expenditure policy as defined in VGLP0007",
					Mask:        0x0006, // Bits 1 and 2
					Choices: []Choice{{
						Id:          "abstain",
						Description: "abstain voting for change",
				...
				Vote: Vote{
					...
					Description: "Enable explicit version upgrades as defined in VGLP0008",
				...
				Vote: Vote{
					...
					Description: "Enable automatic ticket revocations as defined in VGLP0009",
				...
				Vote: Vote{
					...
					Description: "Change block reward subsidy split to 10/80/10 as defined in VGLP0010",
			...
			11: {{
				Vote: Vote{
					Id:          VoteIDBlake3Pow,
					Description: "Change proof of work hashing algorithm to BLAKE3 as defined in VGLP0011",
					Mask:        0x0006, // Bits 1 and 2
					Choices: []Choice{{
						Id:          "abstain",
						Description: "abstain voting for change",
				...
				Vote: Vote{
					...
					Description: "Change block reward subsidy split to 1/89/10 as defined in VGLP0012",
					Mask:        0x0060, // Bits 5 and 6
					Choices: []Choice{{
						Id:          "abstain",
						Description: "abstain voting for change",
		...
		// vigil.networkanization related parameters.
		...
		// 10000 VGL/tew as expense bootstrap
