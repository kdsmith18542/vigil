...
const (
	...
	// algorithm (aka ticket price) agenda defined by VGLP0001.
	...
	// an initial commitment to version 2 GCS filters defined by VGLP0005.
	VoteIDHeaderCommitments = "headercommitments"

	// VoteIDTreasury is the vote ID for the agenda that enables the
	// decentralized treasury opcodes defined by VGLP0006.
	...
	// explicitly enabled via a consensus vote as defined by VGLP0008.
	...
	// ticket revocations as defined in VGLP0009.
	...
	// work hashing algorithm to BLAKE3 as defined in VGLP0011.
...
// Params defines a Vigil network by its parameters.  These parameters may be
// used by Vigil applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// creating a block using the proportions defined in VGLP0010.
	//
	// Deprecated: This will be removed in the next major version bump.
	...
	// to the modified values defined in VGLP0010.
	//
	// Deprecated: This will be removed in the next major version bump.
	...
	// Ticket pool sizes for Vigil PoS. This denotes the number of possible
	...
	// Average number of tickets per block for Vigil PoS.
	...
	// PiKeys is the list of sanctioned Vigiliteia keys. There should be at
...
// modified values defined in VGLP0010.
//
...
// proportions prior to the modified values defined in VGLP0010.  See the
