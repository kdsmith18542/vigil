...
/*
vgld is a full-node Vigil implementation written in Go.

The default options are sane for most users.  This means vgld will work 'out of
...
parsed when vgld starts up.  By default, the configuration file is located at
~/.vgld/vgld.conf on POSIX-style operating systems and %LOCALAPPDATA%\vgld\vgld.conf
...
Application Options:
	...
	-P, --rpcpass=               Password for RPC connections
	    ...
	    --altdnsnames            Specify additional dns names to use when
	                             ...
	                             [supports vgld_ALT_DNSNAMES environment variable]
	...
	-a, --addpeer=               Add a peer to connect with at startup
	    ...
	    --externalip=            Add a public-facing IP to the list of local
	                             external IPs that vgld will advertise to other
	                             peers
	    ...
	    --minrelaytxfee=         The minimum transaction fee in VGL/kB to be
