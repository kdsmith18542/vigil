...
// tests.  They match the Vigil mainnet params as of the time this comment was
// written.
...
// tests.  They match the Vigil testnet version 3 params as of the time this
// comment was written.
...
func TestBIP0032Vectors(t *testing.T) {
	...
	// intended to test applies with the modified hash function used in Vigil.
	//
...
tests:
	for i, test := range tests {
		...
		// are stripped with the legacy Vigil child derivation.
