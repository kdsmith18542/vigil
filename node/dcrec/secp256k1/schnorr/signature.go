...
// ParseSignature parses a signature according to the EC-Schnorr-VGLv0
...
func schnorrVerify(sig *Signature, hash []byte, pubKey *secp256k1.PublicKey) error {
	// The algorithm for producing a EC-Schnorr-VGLv0 signature is described in
...
// schnorrSign generates an EC-Schnorr-VGLv0 signature over the secp256k1 curve
...
// Sign generates an EC-Schnorr-VGLv0 signature over the secp256k1 curve for the
