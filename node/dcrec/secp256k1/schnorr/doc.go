...
that make them unsuitable for use in Vigil.  Some of these details and some
...
EC-Schnorr-VGLv0 that can be made to further harden security for multi-party and
