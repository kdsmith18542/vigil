...
//   - rtReorgStarted:      nil
//   - rtReorgDone:         nil
//   - rtBlockAccepted:     *VGLutil.Block
//   - rtBlockConnected:    *VGLutil.Block
//   - rtBlockDisconnected: *VGLutil.Block
//   - rtVote:              *VGLutil.Tx
...
func (g *BgBlkTmplGenerator) handleBlockConnected(ctx context.Context, state *regenHandlerState, block *VGLutil.Block, chainTip *blockchain.BestState) {
...
//
// This function is only intended for use by the regen handler goroutine.
func (g *BgBlkTmplGenerator) handleBlockDisconnected(ctx context.Context, state *regenHandlerState, block *VGLutil.Block, chainTip *blockchain.BestState) {
	// Clear all vote tracking when the current chain tip changes.
	state.awaitingMinVotesHash = nil
	state.clearSideChainTracking()
...
//
// This function is only intended for use by the regen handler goroutine.
func (g *BgBlkTmplGenerator) handleBlockAccepted(_ context.Context, state *regenHandlerState, block *VGLutil.Block, chainTip *blockchain.BestState) {
...
//
// This function is only intended for use by the regen handler goroutine.
func (g *BgBlkTmplGenerator) handleVote(ctx context.Context, state *regenHandlerState, voteTx *VGLutil.Tx, chainTip *blockchain.BestState) {
...
func (g *BgBlkTmplGenerator) handleRegenEvent(ctx context.Context, state *regenHandlerState, event regenEvent) {
	...
	case rtBlockConnected:
		block := event.value.(*VGLutil.Block)
...
//
// This function is safe for concurrent access.
func (g *BgBlkTmplGenerator) BlockAccepted(block *VGLutil.Block) {
...
//
// This function is safe for concurrent access.
func (g *BgBlkTmplGenerator) BlockConnected(block *VGLutil.Block) {
...
//
// This function is safe for concurrent access.
func (g *BgBlkTmplGenerator) BlockDisconnected(block *VGLutil.Block) {
...
//
// This function is safe for concurrent access.
func (g *BgBlkTmplGenerator) VoteReceived(tx *VGLutil.Tx) {
