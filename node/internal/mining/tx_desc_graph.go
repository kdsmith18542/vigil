...
func newTxDescGraph(forEachRedeemer func(tx *VGLutil.Tx, f func(redeemerTx *TxDesc))) *txDescGraph {
	return &txDescGraph{
...
func (g *txDescGraph) clone(fetchTx TxDescFind) *txDescGraph {
	...
	graph.forEachRedeemer = func(tx *VGLutil.Tx, f func(redeemerTx *TxDesc)) {
