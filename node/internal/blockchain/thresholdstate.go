...
// as defined in VGLP0002 and VGLP0003 has passed and is now active from the point
...
func (b *BlockChain) isLNFeaturesAgendaActive(prevNode *blockNode) (bool, error) {
	...
	// vote as defined in VGLP0002 and VGLP0003.
...
// IsLNFeaturesAgendaActive returns whether or not the LN features agenda vote,
// as defined in VGLP0002 and VGLP0003 has passed and is now active for the block
...
// agenda vote, as defined in VGLP0005 has passed and is now active from the
...
func (b *BlockChain) isHeaderCommitmentsAgendaActive(prevNode *blockNode) (bool, error) {
	...
	// consensus vote as defined in VGLP0005.
...
// IsHeaderCommitmentsAgendaActive returns whether or not the header commitments
// agenda vote, as defined in VGLP0005 has passed and is now active for the block
// AFTER the given block.
//
// This function is safe for concurrent access.
...
// in VGLP0006, has passed and is now active from the point of view of the passed
// block node.
//
// It is important to note that, as the variable name indicates, this function
// expects the block node prior to the block for which the deployment state is
...
func (b *BlockChain) isTreasuryAgendaActive(prevNode *blockNode) (bool, error) {
	...
	// consensus vote as defined in VGLP0006.
...
// defined in VGLP0006, has passed and is now active for the block AFTER the
// given block.
//
// This function is safe for concurrent access.
...
// expenditure policy agenda, as defined in VGLP0007, has passed and is now
...
func (b *BlockChain) isRevertTreasuryPolicyActive(prevNode *blockNode) (bool, error) {
	...
	// expenditure policy consensus vote as defined in VGLP0007.
...
// IsRevertTreasuryPolicyActive returns whether or not the revert treasury
// expenditure policy agenda vote, as defined in VGLP0007, has passed and is now
...
// upgrades agenda, as defined in VGLP0008, has passed and is now active from the
// point of view of the passed block node.
//
// It is important to note that, as the variable name indicates, this function
// expects the block node prior to the block for which the deployment state is
...
func (b *BlockChain) isExplicitVerUpgradesAgendaActive(prevNode *blockNode) (bool, error) {
	...
	// upgrades consensus vote as defined in VGLP0008.
...
// IsExplicitVerUpgradesAgendaActive returns whether or not the explicit version
// upgrades agenda, as defined in VGLP0008, has passed and is now active for the
...
// revocations agenda, as defined in VGLP0009, has passed and is now active from
...
func (b *BlockChain) isAutoRevocationsAgendaActive(prevNode *blockNode) (bool, error) {
	...
	// revocations consensus vote as defined in VGLP0009.
...
// IsAutoRevocationsAgendaActive returns whether or not the automatic ticket
// revocations agenda vote, as defined in VGLP0009, has passed and is now active
...
// block reward subsidy split to 10/80/10, as defined in VGLP0010, has passed and
...
func (b *BlockChain) isSubsidySplitAgendaActive(prevNode *blockNode) (bool, error) {
	...
	// split change consensus vote as defined in VGLP0010.
...
// of work hash function to blake3, as defined in VGLP0011, has passed and is now
// active from the point of view of the passed block node.
//
// It is important to note that, as the variable name indicates, this function
// expects the block node prior to the block for which the deployment state is
...
// IsKawpowAgendaActive returns whether or not the agenda to change the proof
// of work hash function to KawPoW has passed
...
// block reward subsidy split to 1/89/10, as defined in VGLP0012, has passed and
// is now active from the point of view of the passed block node.
//
// It is important to note that, as the variable name indicates, this function
// expects the block node prior to the block for which the deployment state is
...
func (b *BlockChain) isSubsidySplitR2AgendaActive(prevNode *blockNode) (bool, error) {
	// Determine the correct deployment details for the block reward subsidy
	// split change consensus vote as defined in VGLP0012.
