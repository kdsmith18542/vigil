...
const (
	...
	// special script types are currently stored by Vigil, there is a large
...
// of 0.1 VGL which is 10000000 atoms.  Encoding 10000000 as a VLQ would take
...
//            0 (1) -> 0        (1)           *  0.00000000 VGL
//         1000 (2) -> 4        (1)           *  0.00001000 VGL
//        10000 (2) -> 5        (1)           *  0.00010000 VGL
//     12345678 (4) -> 111111101(4)           *  0.12345678 VGL
//     50000000 (4) -> 48       (1)           *  0.50000000 VGL
//    100000000 (4) -> 9        (1)           *  1.00000000 VGL
//    500000000 (5) -> 49       (1)           *  5.00000000 VGL
//   1000000000 (5) -> 10       (1)           * 10.00000000 VGL
// -----------------------------------------------------------------------------
