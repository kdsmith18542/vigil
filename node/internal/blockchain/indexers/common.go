...
import (
	...
	"github.com/vigilnetwork/vgl/internal/blockchain/progresslog"
...
type ChainQueryer interface {
	...
	BlockByHash(*chainhash.Hash) (*VGLutil.Block, error)
