...
//
// This is part of the Indexer interface.
func (idx *ExistsAddrIndex) connectBlock(dbTx database.Tx, block *VGLutil.Block) error {
	...
	blockTxns := make([]*VGLutil.Tx, 0, len(block.Transactions())+
...
//
// This is part of the Indexer interface.
func (idx *ExistsAddrIndex) disconnectBlock(dbTx database.Tx, block *VGLutil.Block) error {
