...
const (
	...
	// ErrInvalidPoWBits indicates the proof of work bits in a block header
	// are not within the valid range.
	ErrInvalidPoWBits = ErrorKind("ErrInvalidPoWBits")

	// ErrNoRegularTxTreeRoot indicates a block does not contain a regular
	// transaction tree root.
	ErrNoRegularTxTreeRoot = ErrorKind("ErrNoRegularTxTreeRoot")

	// ErrNoStakeTxTreeRoot indicates that a block does not contain a stake
	// transaction tree root.
	ErrNoStakeTxTreeRoot = ErrorKind("ErrNoStakeTxTreeRoot")

	// ErrBadFinalState indicates that a block has an invalid final state.
	ErrBadFinalState = ErrorKind("ErrBadFinalState")

	// ErrBadPoolSize indicates that a block has an invalid pool size.
	ErrBadPoolSize = ErrorKind("ErrBadPoolSize")
