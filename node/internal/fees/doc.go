...
second layer alternatives, etc). Also, the current fill rate of blocks in Vigil
...
out earlier should be sufficient for current fill rate of Vigil's network.
...
[5] Source for the original VGLfeesim and estimator work:
https://github.com/matheusd/VGLfeesim_dev

[6] Source for the current VGLfeesim, using this module:
