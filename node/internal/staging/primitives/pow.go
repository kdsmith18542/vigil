...
// However, it is only used in Vigil to encode unsigned 256-bit integers which
...
// however, difficulty bits are only used in Vigil to encode unsigned 256-bit
...
// CalcWork calculates a work value from difficulty bits.  Vigil increases the
