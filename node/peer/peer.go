...
// Peer provides a basic concurrent safe Vigil peer for handling Vigil
...
// callbacks for handling Vigil protocol messages.
//
...
type Peer struct {
	...
	// kawpowHasher is the hash.Hash object that is used by readMessage
...
// newPeerBase returns a new base Vigil peer based on the inbound flag.  This
...
// NewInboundPeer returns a new inbound Vigil peer. Use Start to begin
// processing incoming and outgoing messages.
func NewInboundPeer(cfg *Config) *Peer {
	return newPeerBase(cfg, true)
}

// NewOutboundPeer returns a new outbound Vigil peer.
