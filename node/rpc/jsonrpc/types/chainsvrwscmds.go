...
// from JSON.  Contains Vigil addition.
...
func init() {
	...
	flags := VGLjson.UFWebsocketOnly

	VGLjson.MustRegister(Method("authenticate"), (*AuthenticateCmd)(nil), flags)
	VGLjson.MustRegister(Method("loadtxfilter"), (*LoadTxFilterCmd)(nil), flags)
	VGLjson.MustRegister(Method("notifyblocks"), (*NotifyBlocksCmd)(nil), flags)
	VGLjson.MustRegister(Method("notifywork"), (*NotifyWorkCmd)(nil), flags)
	VGLjson.MustRegister(Method("notifytspend"), (*NotifyTSpendCmd)(nil), flags)
	VGLjson.MustRegister(Method("notifynewtransactions"), (*NotifyNewTransactionsCmd)(nil), flags)
	VGLjson.MustRegister(Method("notifynewtickets"), (*NotifyNewTicketsCmd)(nil), flags)
	VGLjson.MustRegister(Method("notifywinningtickets"), (*NotifyWinningTicketsCmd)(nil), flags)
	VGLjson.MustRegister(Method("notifymixmessages"), (*NotifyMixMessagesCmd)(nil), flags)
	VGLjson.MustRegister(Method("rebroadcastwinners"), (*RebroadcastWinnersCmd)(nil), flags)
	VGLjson.MustRegister(Method("session"), (*SessionCmd)(nil), flags)
	VGLjson.MustRegister(Method("stopnotifyblocks"), (*StopNotifyBlocksCmd)(nil), flags)
	VGLjson.MustRegister(Method("stopnotifywork"), (*StopNotifyWorkCmd)(nil), flags)
	VGLjson.MustRegister(Method("stopnotifytspend"), (*StopNotifyTSpendCmd)(nil), flags)
	VGLjson.MustRegister(Method("stopnotifynewtransactions"), (*StopNotifyNewTransactionsCmd)(nil), flags)
