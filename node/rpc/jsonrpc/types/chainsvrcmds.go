...
// transaction hash and output number pair. Contains Vigil additions.
...
type CreateRawTransactionCmd struct {
	...
	Amounts  map[string]float64 `jsonrpcusage:"{\"address\":amount,...}"` // In VGL
	LockTime *int64
	Expiry   *int64
}
...
func init() {
	...
	flags := VGLjson.UsageFlag(0)

	VGLjson.MustRegister(Method("addnode"), (*AddNodeCmd)(nil), flags)
	VGLjson.MustRegister(Method("createrawssrtx"), (*CreateRawSSRtxCmd)(nil), flags)
	VGLjson.MustRegister(Method("createrawsstx"), (*CreateRawSStxCmd)(nil), flags)
	VGLjson.MustRegister(Method("createrawtransaction"), (*CreateRawTransactionCmd)(nil), flags)
	VGLjson.MustRegister(Method("debuglevel"), (*DebugLevelCmd)(nil), flags)
	VGLjson.MustRegister(Method("decoderawtransaction"), (*DecodeRawTransactionCmd)(nil), flags)
	VGLjson.MustRegister(Method("decodescript"), (*DecodeScriptCmd)(nil), flags)
	VGLjson.MustRegister(Method("estimatefee"), (*EstimateFeeCmd)(nil), flags)
	VGLjson.MustRegister(Method("estimatesmartfee"), (*EstimateSmartFeeCmd)(nil), flags)
	VGLjson.MustRegister(Method("estimatestakediff"), (*EstimateStakeDiffCmd)(nil), flags)
	VGLjson.MustRegister(Method("existsaddress"), (*ExistsAddressCmd)(nil), flags)
	VGLjson.MustRegister(Method("existsaddresses"), (*ExistsAddressesCmd)(nil), flags)
	VGLjson.MustRegister(Method("existsliveticket"), (*ExistsLiveTicketCmd)(nil), flags)
	VGLjson.MustRegister(Method("existslivetickets"), (*ExistsLiveTicketsCmd)(nil), flags)
	VGLjson.MustRegister(Method("existsmempooltxs"), (*ExistsMempoolTxsCmd)(nil), flags)
	VGLjson.MustRegister(Method("generate"), (*GenerateCmd)(nil), flags)
	VGLjson.MustRegister(Method("getaddednodeinfo"), (*GetAddedNodeInfoCmd)(nil), flags)
	VGLjson.MustRegister(Method("getbestblock"), (*GetBestBlockCmd)(nil), flags)
	VGLjson.MustRegister(Method("getbestblockhash"), (*GetBestBlockHashCmd)(nil), flags)
	VGLjson.MustRegister(Method("getblock"), (*GetBlockCmd)(nil), flags)
	VGLjson.MustRegister(Method("getblockchaininfo"), (*GetBlockChainInfoCmd)(nil), flags)
	VGLjson.MustRegister(Method("getblockcount"), (*GetBlockCountCmd)(nil), flags)
	VGLjson.MustRegister(Method("getblockhash"), (*GetBlockHashCmd)(nil), flags)
	VGLjson.MustRegister(Method("getblockheader"), (*GetBlockHeaderCmd)(nil), flags)
	VGLjson.MustRegister(Method("getblocksubsidy"), (*GetBlockSubsidyCmd)(nil), flags)
	VGLjson.MustRegister(Method("getcfilterv2"), (*GetCFilterV2Cmd)(nil), flags)
	VGLjson.MustRegister(Method("getchaintips"), (*GetChainTipsCmd)(nil), flags)
	VGLjson.MustRegister(Method("getcoinsupply"), (*GetCoinSupplyCmd)(nil), flags)
	VGLjson.MustRegister(Method("getconnectioncount"), (*GetConnectionCountCmd)(nil), flags)
	VGLjson.MustRegister(Method("getcurrentnet"), (*GetCurrentNetCmd)(nil), flags)
	VGLjson.MustRegister(Method("getdifficulty"), (*GetDifficultyCmd)(nil), flags)
	VGLjson.MustRegister(Method("getgenerate"), (*GetGenerateCmd)(nil), flags)
	VGLjson.MustRegister(Method("gethashespersec"), (*GetHashesPerSecCmd)(nil), flags)
	VGLjson.MustRegister(Method("getheaders"), (*GetHeadersCmd)(nil), flags)
	VGLjson.MustRegister(Method("getinfo"), (*GetInfoCmd)(nil), flags)
	VGLjson.MustRegister(Method("getmempoolinfo"), (*GetMempoolInfoCmd)(nil), flags)
	VGLjson.MustRegister(Method("getmininginfo"), (*GetMiningInfoCmd)(nil), flags)
	VGLjson.MustRegister(Method("getmixmessage"), (*GetMixMessageCmd)(nil), flags)
	VGLjson.MustRegister(Method("getmixpairrequests"), (*GetMixPairRequestsCmd)(nil), flags)
	VGLjson.MustRegister(Method("getnetworkinfo"), (*GetNetworkInfoCmd)(nil), flags)
	VGLjson.MustRegister(Method("getnettotals"), (*GetNetTotalsCmd)(nil), flags)
	VGLjson.MustRegister(Method("getnetworkhashps"), (*GetNetworkHashPSCmd)(nil), flags)
	VGLjson.MustRegister(Method("getpeerinfo"), (*GetPeerInfoCmd)(nil), flags)
	VGLjson.MustRegister(Method("getrawmempool"), (*GetRawMempoolCmd)(nil), flags)
	VGLjson.MustRegister(Method("getrawtransaction"), (*GetRawTransactionCmd)(nil), flags)
	VGLjson.MustRegister(Method("getstakedifficulty"), (*GetStakeDifficultyCmd)(nil), flags)
	VGLjson.MustRegister(Method("getstakeversioninfo"), (*GetStakeVersionInfoCmd)(nil), flags)
	VGLjson.MustRegister(Method("getstakeversions"), (*GetStakeVersionsCmd)(nil), flags)
	VGLjson.MustRegister(Method("getticketpoolvalue"), (*GetTicketPoolValueCmd)(nil), flags)
	VGLjson.MustRegister(Method("gettreasurybalance"), (*GetTreasuryBalanceCmd)(nil), flags)
	VGLjson.MustRegister(Method("gettreasuryspendvotes"), (*GetTreasurySpendVotesCmd)(nil), flags)
	VGLjson.MustRegister(Method("gettxout"), (*GetTxOutCmd)(nil), flags)
	VGLjson.MustRegister(Method("gettxoutsetinfo"), (*GetTxOutSetInfoCmd)(nil), flags)
	VGLjson.MustRegister(Method("getvoteinfo"), (*GetVoteInfoCmd)(nil), flags)
	VGLjson.MustRegister(Method("getwork"), (*GetWorkCmd)(nil), flags)
	VGLjson.MustRegister(Method("help"), (*HelpCmd)(nil), flags)
	VGLjson.MustRegister(Method("invalidateblock"), (*InvalidateBlockCmd)(nil), flags)
	VGLjson.MustRegister(Method("livetickets"), (*LiveTicketsCmd)(nil), flags)
	VGLjson.MustRegister(Method("node"), (*NodeCmd)(nil), flags)
	VGLjson.MustRegister(Method("ping"), (*PingCmd)(nil), flags)
	VGLjson.MustRegister(Method("reconsiderblock"), (*ReconsiderBlockCmd)(nil), flags)
	VGLjson.MustRegister(Method("regentemplate"), (*RegenTemplateCmd)(nil), flags)
	VGLjson.MustRegister(Method("sendrawmixmessage"), (*SendRawMixMessageCmd)(nil), flags)
	VGLjson.MustRegister(Method("sendrawtransaction"), (*SendRawTransactionCmd)(nil), flags)
	VGLjson.MustRegister(Method("setgenerate"), (*SetGenerateCmd)(nil), flags)
	VGLjson.MustRegister(Method("startprofiler"), (*StartProfilerCmd)(nil), flags)
	VGLjson.MustRegister(Method("stop"), (*StopCmd)(nil), flags)
	VGLjson.MustRegister(Method("stopprofiler"), (*StopProfilerCmd)(nil), flags)
	VGLjson.MustRegister(Method("submitblock"), (*SubmitBlockCmd)(nil), flags)
	VGLjson.MustRegister(Method("ticketfeeinfo"), (*TicketFeeInfoCmd)(nil), flags)
	VGLjson.MustRegister(Method("ticketsforaddress"), (*TicketsForAddressCmd)(nil), flags)
	VGLjson.MustRegister(Method("ticketvwap"), (*TicketVWAPCmd)(nil), flags)
	VGLjson.MustRegister(Method("txfeeinfo"), (*TxFeeInfoCmd)(nil), flags)
	VGLjson.MustRegister(Method("validateaddress"), (*ValidateAddressCmd)(nil), flags)
	VGLjson.MustRegister(Method("verifychain"), (*VerifyChainCmd)(nil), flags)
