...
func TestChainSvrCmds(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "addnode",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("addnode"), "127.0.0.1", ANRemove)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("createrawtransaction"), `[{"amount":0.0123,"txid":"123","vout":1}]`,
					`{"456":0.0123}`)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("createrawtransaction"), `[{"amount":0.0123,"txid":"123","vout":1,"tree":0}]`,
			...
			staticCmd: func() interface{} {
				...
				amounts := map[string]float64{"456": .0123}
				return NewCreateRawTransactionCmd(txInputs, amounts, VGLjson.Int64(12312333333), VGLjson.Int64(12312333333))
			},
			...
			unmarshalled: &CreateRawTransactionCmd{
				Inputs:   []TransactionInput{{Amount: 0.0123, Txid: "123", Vout: 1}},
				Amounts:  map[string]float64{"456": .0123},
				LockTime: VGLjson.Int64(12312333333),
				Expiry:   VGLjson.Int64(12312333333),
			},
		},
		{
			name: "debuglevel",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("debuglevel"), "trace")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("decoderawtransaction"), "123")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "decodescript",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("decodescript"), "00")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("decodescript"), "00", VGLjson.Uint16(1))
			},
			staticCmd: func() interface{} {
				cmd := NewDecodeScriptCmd("00")
				cmd.Version = VGLjson.Uint16(1)
				return cmd
			},
			marshalled:   `{"jsonrpc":"1.0","method":"decodescript","params":["00",1],"id":1}`,
			unmarshalled: &DecodeScriptCmd{HexScript: "00", Version: VGLjson.Uint16(1)},
		},
		{
			name: "estimatefee",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("estimatefee"), 6)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("estimatesmartfee"), 6)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("estimatesmartfee"), 6, EstimateSmartFeeConservative)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "generate",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("generate"), 1)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getaddednodeinfo"), true)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getaddednodeinfo"), true, "127.0.0.1")
			},
			staticCmd: func() interface{} {
				return NewGetAddedNodeInfoCmd(true, VGLjson.String("127.0.0.1"))
			},
			marshalled: `{"jsonrpc":"1.0","method":"getaddednodeinfo","params":[true,"127.0.0.1"],"id":1}`,
			unmarshalled: &GetAddedNodeInfoCmd{
				DNS:  true,
				Node: VGLjson.String("127.0.0.1"),
			},
		},
		{
			name: "getbestblock",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getbestblock"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getbestblockhash"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getblock",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getblock"), "123")
			},
			staticCmd: func() interface{} {
			...
			unmarshalled: &GetBlockCmd{
				Hash:      "123",
				Verbose:   VGLjson.Bool(true),
				VerboseTx: VGLjson.Bool(false),
			},
		},
		{
			...
			newCmd: func() (interface{}, error) {
				...
				// exercise that path.
				verbosePtr := VGLjson.Bool(true)
				return VGLjson.NewCmd(Method("getblock"), "123", &verbosePtr)
			},
			staticCmd: func() interface{} {
				return NewGetBlockCmd("123", VGLjson.Bool(true), nil)
			},
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getblock"), "123", true, true)
			},
			staticCmd: func() interface{} {
				return NewGetBlockCmd("123", VGLjson.Bool(true), VGLjson.Bool(true))
			},
			marshalled: `{"jsonrpc":"1.0","method":"getblock","params":["123",true,true],"id":1}`,
			unmarshalled: &GetBlockCmd{
				Hash:      "123",
				Verbose:   VGLjson.Bool(true),
				VerboseTx: VGLjson.Bool(true),
			},
		},
		{
			name: "getblockchaininfo",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getblockchaininfo"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getblockcount",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getblockcount"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getblockhash",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getblockhash"), 123)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getblockheader",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getblockheader"), "123")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getblocksubsidy"), 123, 256)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getcfilterv2",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getcfilterv2"), "123")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getchaintips",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getchaintips"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getconnectioncount"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getcurrentnet",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getcurrentnet"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getdifficulty",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getdifficulty"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getgenerate",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getgenerate"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("gethashespersec"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getinfo",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getinfo"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getmempoolinfo",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getmempoolinfo"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getmininginfo",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getmininginfo"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getmixpairrequests"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getnetworkinfo",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getnetworkinfo"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getnettotals",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getnettotals"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getnetworkhashps"))
			},
			staticCmd: func() interface{} {
			...
			unmarshalled: &GetNetworkHashPSCmd{
				Blocks: VGLjson.Int(120),
				Height: VGLjson.Int(-1),
			},
		},
		{
			name: "getnetworkhashps optional1",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getnetworkhashps"), 200)
			},
			staticCmd: func() interface{} {
				return NewGetNetworkHashPSCmd(VGLjson.Int(200), nil)
			},
			marshalled: `{"jsonrpc":"1.0","method":"getnetworkhashps","params":[200],"id":1}`,
			unmarshalled: &GetNetworkHashPSCmd{
				Blocks: VGLjson.Int(200),
				Height: VGLjson.Int(-1),
			},
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getnetworkhashps"), 200, 123)
			},
			staticCmd: func() interface{} {
				return NewGetNetworkHashPSCmd(VGLjson.Int(200), VGLjson.Int(123))
			},
			marshalled: `{"jsonrpc":"1.0","method":"getnetworkhashps","params":[200,123],"id":1}`,
			unmarshalled: &GetNetworkHashPSCmd{
				Blocks: VGLjson.Int(200),
				Height: VGLjson.Int(123),
			},
		},
		{
			name: "getpeerinfo",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getpeerinfo"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getrawmempool",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getrawmempool"))
			},
			staticCmd: func() interface{} {
			...
			unmarshalled: &GetRawMempoolCmd{
				Verbose: VGLjson.Bool(false),
			},
		},
		{
			name: "getrawmempool optional",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getrawmempool"), false)
			},
			staticCmd: func() interface{} {
				return NewGetRawMempoolCmd(VGLjson.Bool(false), nil)
			},
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getrawmempool"), false, "all")
			},
			staticCmd: func() interface{} {
				return NewGetRawMempoolCmd(VGLjson.Bool(false), VGLjson.String("all"))
			},
			marshalled: `{"jsonrpc":"1.0","method":"getrawmempool","params":[false,"all"],"id":1}`,
			unmarshalled: &GetRawMempoolCmd{
				Verbose: VGLjson.Bool(false),
				TxType:  VGLjson.String("all"),
			},
		},
		{
			name: "getrawtransaction",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getrawtransaction"), "123")
			},
			staticCmd: func() interface{} {
			...
			unmarshalled: &GetRawTransactionCmd{
				Txid:    "123",
				Verbose: VGLjson.Int(0),
			},
		},
		{
			name: "getrawtransaction optional",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getrawtransaction"), "123", 1)
			},
			staticCmd: func() interface{} {
				return NewGetRawTransactionCmd("123", VGLjson.Int(1))
			},
			marshalled: `{"jsonrpc":"1.0","method":"getrawtransaction","params":["123",1],"id":1}`,
			unmarshalled: &GetRawTransactionCmd{
				Txid:    "123",
				Verbose: VGLjson.Int(1),
			},
		},
		{
			name: "getstakeversions",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getstakeversions"), "deadbeef", 1)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "gettxout",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("gettxout"), "123", 1, 0)
			},
			staticCmd: func() interface{} {
			...
			unmarshalled: &GetTxOutCmd{
				...
				Vout:           1,
				Tree:           0,
				IncludeMempool: VGLjson.Bool(true),
			},
		},
		{
			name: "gettxout optional",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("gettxout"), "123", 1, 0, true)
			},
			staticCmd: func() interface{} {
				return NewGetTxOutCmd("123", 1, 0, VGLjson.Bool(true))
			},
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("gettxoutsetinfo"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "getvoteinfo",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getvoteinfo"), 1)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("gettreasuryspendvotes"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("gettreasuryspendvotes"), "123", []string{"456"})
			},
			staticCmd: func() interface{} {
				return NewGetTreasurySpendVotesCmd(VGLjson.String("123"), &[]string{"456"})
			},
			marshalled: `{"jsonrpc":"1.0","method":"gettreasuryspendvotes","params":["123",["456"]],"id":1}`,
			unmarshalled: &GetTreasurySpendVotesCmd{
				Block:   VGLjson.String("123"),
				TSpends: &[]string{"456"},
			},
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("gettreasuryspendvotes"), "", []string{"456"})
			},
			staticCmd: func() interface{} {
				return NewGetTreasurySpendVotesCmd(VGLjson.String(""), &[]string{"456"})
			},
			marshalled: `{"jsonrpc":"1.0","method":"gettreasuryspendvotes","params":["",["456"]],"id":1}`,
			unmarshalled: &GetTreasurySpendVotesCmd{
				Block:   VGLjson.String(""),
				TSpends: &[]string{"456"},
			},
		},
		{
			name: "getwork",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getwork"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("getwork"), "00112233")
			},
			staticCmd: func() interface{} {
				return NewGetWorkCmd(VGLjson.String("00112233"))
			},
			marshalled: `{"jsonrpc":"1.0","method":"getwork","params":["00112233"],"id":1}`,
			unmarshalled: &GetWorkCmd{
				Data: VGLjson.String("00112233"),
			},
		},
		{
			name: "help",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("help"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "help optional",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("help"), "getblock")
			},
			staticCmd: func() interface{} {
				return NewHelpCmd(VGLjson.String("getblock"))
			},
			marshalled: `{"jsonrpc":"1.0","method":"help","params":["getblock"],"id":1}`,
			unmarshalled: &HelpCmd{
				Command: VGLjson.String("getblock"),
			},
		},
		{
			name: "node option remove",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("node"), NRemove, "1.1.1.1")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("node"), NDisconnect, "1.1.1.1")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("node"), NConnect, "1.1.1.1", "perm")
			},
			staticCmd: func() interface{} {
				return NewNodeCmd("connect", "1.1.1.1", VGLjson.String("perm"))
			},
			marshalled: `{"jsonrpc":"1.0","method":"node","params":["connect","1.1.1.1","perm"],"id":1}`,
			unmarshalled: &NodeCmd{
				SubCmd:        NConnect,
				Target:        "1.1.1.1",
				ConnectSubCmd: VGLjson.String("perm"),
			},
		},
		{
			name: "ping",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("ping"))
			},
			staticCmd: func() interface{} {
				return NewPingCmd()
			},
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("sendrawmixmessage"), "mixpairrequest", "1122")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("sendrawtransaction"), "1122")
			},
			staticCmd: func() interface{} {
			...
			unmarshalled: &SendRawTransactionCmd{
				HexTx:         "1122",
				AllowHighFees: VGLjson.Bool(false),
			},
		},
		{
			name: "sendrawtransaction optional",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("sendrawtransaction"), "1122", false)
			},
			staticCmd: func() interface{} {
				return NewSendRawTransactionCmd("1122", VGLjson.Bool(false))
			},
		...
		},
		{
			name: "setgenerate",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("setgenerate"), true)
			},
			staticCmd: func() interface{} {
			...
			unmarshalled: &SetGenerateCmd{
				Generate:     true,
				GenProcLimit: VGLjson.Int(-1),
			},
		},
		{
			name: "setgenerate optional",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("setgenerate"), true, 6)
			},
			staticCmd: func() interface{} {
				return NewSetGenerateCmd(true, VGLjson.Int(6))
			},
			marshalled: `{"jsonrpc":"1.0","method":"setgenerate","params":[true,6],"id":1}`,
			unmarshalled: &SetGenerateCmd{
				Generate:     true,
				GenProcLimit: VGLjson.Int(6),
			},
		},
		{
			name: "startprofiler",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("startprofiler"), "127.0.0.1:6060")
			},
			staticCmd: func() interface{} {
			...
			unmarshalled: &StartProfilerCmd{
				Addr:             "127.0.0.1:6060",
				AllowNonLoopback: VGLjson.Bool(false),
			},
		},
		{
			name: "startprofiler allownonloopback",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("startprofiler"), "127.0.0.1:6060", true)
			},
			staticCmd: func() interface{} {
				return NewStartProfilerCmd("127.0.0.1:6060", VGLjson.Bool(true))
			},
			marshalled: `{"jsonrpc":"1.0","method":"startprofiler","params":["127.0.0.1:6060",true],"id":1}`,
			unmarshalled: &StartProfilerCmd{
				Addr:             "127.0.0.1:6060",
				AllowNonLoopback: VGLjson.Bool(true),
			},
		},
		{
			name: "stop",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("stop"))
			},
			staticCmd: func() interface{} {
				return NewStopCmd()
			},
		...
		},
		{
			name: "stopprofiler",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("stopprofiler"))
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "submitblock",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("submitblock"), "112233")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("submitblock"), "112233", `{"workid":"12345"}`)
			},
			staticCmd: func() interface{} {
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("validateaddress"), "1Address")
			},
			staticCmd: func() interface{} {
		...
		},
		{
			name: "verifychain",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("verifychain"))
			},
			staticCmd: func() interface{} {
			...
			unmarshalled: &VerifyChainCmd{
				CheckLevel: VGLjson.Int64(3),
				CheckDepth: VGLjson.Int64(288),
			},
		},
		{
			name: "verifychain optional1",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("verifychain"), 2)
			},
			staticCmd: func() interface{} {
				return NewVerifyChainCmd(VGLjson.Int64(2), nil)
			},
			marshalled: `{"jsonrpc":"1.0","method":"verifychain","params":[2],"id":1}`,
			unmarshalled: &VerifyChainCmd{
				CheckLevel: VGLjson.Int64(2),
				CheckDepth: VGLjson.Int64(288),
			},
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("verifychain"), 2, 500)
			},
			staticCmd: func() interface{} {
				return NewVerifyChainCmd(VGLjson.Int64(2), VGLjson.Int64(500))
			},
			marshalled: `{"jsonrpc":"1.0","method":"verifychain","params":[2,500],"id":1}`,
			unmarshalled: &VerifyChainCmd{
				CheckLevel: VGLjson.Int64(2),
				CheckDepth: VGLjson.Int64(500),
			},
		},
		{
			name: "verifymessage",
			newCmd: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("verifymessage"), "1Address", "301234", "test")
			},
			staticCmd: func() interface{} {
