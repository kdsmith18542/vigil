...
func TestChainSvrWsNtfns(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "blockconnected",
			newNtfn: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("blockconnected"), "header", []string{"tx0", "tx1"})
			},
			staticNtfn: func() interface{} {
		...
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("blockdisconnected"), "header")
			},
			staticNtfn: func() interface{} {
		...
		},
		{
			name: "newtickets",
			newNtfn: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("newtickets"), "123", 100, 3, []string{"a", "b"})
			},
			staticNtfn: func() interface{} {
		...
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("relevanttxaccepted"), "001122")
			},
			staticNtfn: func() interface{} {
		...
		},
		{
			name: "txaccepted",
			newNtfn: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("txaccepted"), "123", 1.5)
			},
			staticNtfn: func() interface{} {
		...
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("txacceptedverbose"), `{"hex":"001122","txid":"123","version":1,"locktime":4294967295,"vin":null,"vout":null,"confirmations":0}`)
			},
			staticNtfn: func() interface{} {
		...
		},
		{
			name: "winningtickets",
			newNtfn: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("winningtickets"), "123", 100, map[string]string{"a": "b"})
			},
			staticNtfn: func() interface{} {
		...
		},
		{
			name: "mixmessage",
			newNtfn: func() (interface{}, error) {
				return VGLjson.NewCmd(Method("mixmessage"), "mixpairrequest", "1122")
			},
			staticNtfn: func() interface{} {
	...
	for i, test := range tests {
		...
		marshalled, err := VGLjson.MarshalCmd("1.0", nil, test.staticNtfn())
		if err != nil {
		...
		// notifications.
		marshalled, err = VGLjson.MarshalCmd("1.0", nil, cmd)
		if err != nil {
			t.Errorf("MarshalCmd #%d (%s) unexpected error: %v", i,
				test.name, err)
			continue
