...
// units, "1eN VGL" is returned, where N is the AmountUnit.
func (u AmountUnit) String() string {
	...
	case AmountAtom:
		return "Atom"
	default:
		return "1e" + strconv.FormatInt(int64(u), 10) + " VGL"
	}
}
...
//
// NewAmount is for specifically for converting VGL to Atoms (atomic units).
...
// useful for services that build on top of Vigil (for example, calculating
