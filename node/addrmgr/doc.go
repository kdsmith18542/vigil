...
/*
Package addrmgr implements a concurrency-safe Vigil address manager.

# Address Manager Overview

The Vigil network relies on fully-validating nodes that relay transactions and
...
source of IP addresses to connect to and share with other nodes.  The Vigil
