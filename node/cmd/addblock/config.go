...
var (
	vgldHomeDir     = VGLutil.AppDataDir("vgld", false)
	defaultDataDir  = filepath.Join(vgldHomeDir, "data")
...
type config struct {
	DataDir           string `short:"b" long:"datadir" description:"Location of the vgld data directory"`
