...
# Ensure git and vglctl are available and this is running in a git repo.
...
MAINNET_BLOCK_HEIGHT=$(($($vglctl getblockcount) - 4032))
MAINNET_BLOCK_HASH=$($vglctl getblockhash $MAINNET_BLOCK_HEIGHT)
TESTNET_BLOCK_HEIGHT=$(($($vglctlt getblockcount) - 10080))
...
\`\`\`
\$ vglctl getblockhash ${MAINNET_BLOCK_HEIGHT}
${MAINNET_BLOCK_HASH}
\$ vglctl --testnet getblockhash ${TESTNET_BLOCK_HEIGHT}
${TESTNET_BLOCK_HASH}
\`\`\`
"
