...
type NotificationHandlers struct {
	...
	// made to register for the notification and the function is non-nil.
	OnTxAccepted func(hash *chainhash.Hash, amount VGLutil.Amount)
...
func parseTxAcceptedNtfnParams(params []json.RawMessage) (*chainhash.Hash,
	...
	// Bounds check amount.
	amt, err := VGLutil.NewAmount(famt)
	if err != nil {
		return nil, 0, err
	}
...
//
// NOTE: This is a vgld extension and requires a websocket connection.
