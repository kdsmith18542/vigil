...
func (r *FutureGetTicketPoolValueResult) Receive() (VGLutil.Amount, error) {
	res, err := receiveFuture(r.ctx, r.c)
	if err != nil {
		return 0, err
	}
...
//
// NOTE: This is a vgld extension.
func (c *Client) GetTicketPoolValue(ctx context.Context) (VGLutil.Amount, error) {
...
//
// NOTE: This is a Vigil extension.
...
func (r *FutureTicketVWAPResult) Receive() (VGLutil.Amount, error) {
	res, err := receiveFuture(r.ctx, r.c)
	if err != nil {
		return 0, err
	}
	...
	amt, err := VGLutil.NewAmount(vwap)
	if err != nil {
		return 0, err
	}
...
//
// NOTE: This is a Vigil extension.
func (c *Client) TicketVWAP(ctx context.Context, start *uint32, end *uint32) (VGLutil.Amount, error) {
