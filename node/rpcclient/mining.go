...
func (c *Client) SubmitBlockAsync(ctx context.Context, block *VGLutil.Block, options *chainjson.SubmitBlockOptions) *FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
// SubmitBlock attempts to submit a new block into the Vigil network.
func (c *Client) SubmitBlock(ctx context.Context, block *VGLutil.Block, options *chainjson.SubmitBlockOptions) error {
