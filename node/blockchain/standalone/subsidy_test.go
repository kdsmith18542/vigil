...
// the tests.  They match the Vigil mainnet params as of the time this comment
// was written.
...
func TestSubsidyCacheCalcs(t *testing.T) {
	...
	tests := []struct {
		...
		name:         "negative height, use VGLP0010",
		params:       mockMainNetParams,
		height:       -1,
		numVotes:     0,
		variant:      SSVVGLP0010,
		...
		name:         "negative height, use VGLP0012",
		params:       mockMainNetParams,
		height:       -1,
		numVotes:     0,
		variant:      SSVVGLP0012,
		...
		name:         "height 1 (initial payouts), use VGLP0010",
		params:       mockMainNetParams,
		height:       1,
		numVotes:     0,
		variant:      SSVVGLP0010,
		...
		name:         "height 1 (initial payouts), use VGLP0012",
		params:       mockMainNetParams,
		height:       1,
		numVotes:     0,
		variant:      SSVVGLP0012,
		...
		name:         "height 2 (first non-special block prior voting start), use VGLP0010",
		params:       mockMainNetParams,
		height:       2,
		numVotes:     0,
		variant:      SSVVGLP0010,
		...
		name:         "height 2 (first non-special block prior voting start), use VGLP0012",
		params:       mockMainNetParams,
		height:       2,
		numVotes:     0,
		variant:      SSVVGLP0012,
		...
		name:         "height 4094 (two blocks prior to voting start), use VGLP0010",
		params:       mockMainNetParams,
		height:       4094,
		numVotes:     0,
		variant:      SSVVGLP0010,
		...
		name:         "height 4094 (two blocks prior to voting start), use VGLP0012",
		params:       mockMainNetParams,
		height:       4094,
		numVotes:     0,
		variant:      SSVVGLP0012,
		...
		name:         "height 4095 (final block prior to voting start), use VGLP0010",
		params:       mockMainNetParams,
		height:       4095,
		numVotes:     0,
		variant:      SSVVGLP0010,
		...
		name:         "height 4095 (final block prior to voting start), use VGLP0012",
		params:       mockMainNetParams,
		height:       4095,
		numVotes:     0,
		variant:      SSVVGLP0012,
		...
		name:         "height 4096 (voting start), 5 votes, use VGLP0010",
		params:       mockMainNetParams,
		height:       4096,
		numVotes:     5,
		variant:      SSVVGLP0010,
		...
		name:         "height 4096 (voting start), 5 votes, use VGLP0012",
		params:       mockMainNetParams,
		height:       4096,
		numVotes:     5,
		variant:      SSVVGLP0012,
		...
		name:         "height 4096 (voting start), 4 votes, use VGLP0010",
		params:       mockMainNetParams,
		height:       4096,
		numVotes:     4,
		variant:      SSVVGLP0010,
		...
		name:         "height 4096 (voting start), 4 votes, use VGLP0012",
		params:       mockMainNetParams,
		height:       4096,
		numVotes:     4,
		variant:      SSVVGLP0012,
		...
		name:         "height 4096 (voting start), 3 votes, use VGLP0010",
		params:       mockMainNetParams,
		height:       4096,
		numVotes:     3,
		variant:      SSVVGLP0010,
		...
		name:         "height 4096 (voting start), 3 votes, use VGLP0012",
		params:       mockMainNetParams,
		height:       4096,
		numVotes:     3,
		variant:      SSVVGLP0012,
		...
		name:         "height 4096 (voting start), 2 votes, use VGLP0010",
		params:       mockMainNetParams,
		height:       4096,
		numVotes:     2,
		variant:      SSVVGLP0010,
		...
		name:         "height 4096 (voting start), 2 votes, use VGLP0012",
		params:       mockMainNetParams,
		height:       4096,
		numVotes:     2,
		variant:      SSVVGLP0012,
		...
		name:         "height 6143 (final block prior to 1st reduction), 5 votes, use VGLP0010",
		params:       mockMainNetParams,
		height:       6143,
		numVotes:     5,
		variant:      SSVVGLP0010,
		...
		name:         "height 6143 (final block prior to 1st reduction), 5 votes, use VGLP0012",
		params:       mockMainNetParams,
		height:       6143,
		numVotes:     5,
		variant:      SSVVGLP0012,
		...
		name:         "height 6144 (1st block in 1st reduction), 5 votes, use VGLP0010",
		params:       mockMainNetParams,
		height:       6144,
		numVotes:     5,
		variant:      SSVVGLP0010,
		...
		name:         "height 6144 (1st block in 1st reduction), 5 votes, use VGLP0012",
		params:       mockMainNetParams,
		height:       6144,
		numVotes:     5,
		variant:      SSVVGLP0012,
		...
		name:         "height 6144 (1st block in 1st reduction), 4 votes, use VGLP0010",
		params:       mockMainNetParams,
		height:       6144,
		numVotes:     4,
		variant:      SSVVGLP0010,
		...
		name:         "height 6144 (1st block in 1st reduction), 4 votes, use VGLP0012",
		params:       mockMainNetParams,
		height:       6144,
		numVotes:     4,
		variant:      SSVVGLP0012,
		...
		name:         "height 12287 (last block in 1st reduction), 5 votes, use VGLP0010",
		params:       mockMainNetParams,
		height:       12287,
		numVotes:     5,
		variant:      SSVVGLP0010,
		...
		name:         "height 12287 (last block in 1st reduction), 5 votes, use VGLP0012",
		params:       mockMainNetParams,
		height:       12287,
		numVotes:     5,
		variant:      SSVVGLP0012,
		...
		name:         "height 12288 (1st block in 2nd reduction), 5 votes, use VGLP0010",
		params:       mockMainNetParams,
		height:       12288,
		numVotes:     5,
		variant:      SSVVGLP0010,
		...
		name:         "height 12288 (1st block in 2nd reduction), 5 votes, use VGLP0012",
		params:       mockMainNetParams,
		height:       12288,
		numVotes:     5,
		variant:      SSVVGLP0012,
		...
		name:         "height 307200 (1st block in 50th reduction), 5 votes, use VGLP0010",
		params:       mockMainNetParams,
		height:       307200,
		numVotes:     5,
		variant:      SSVVGLP0010,
		...
		name:         "height 307200 (1st block in 50th reduction), 5 votes, use VGLP0012",
		params:       mockMainNetParams,
		height:       307200,
		numVotes:     5,
		variant:      SSVVGLP0012,
		...
		name:         "height 307200 (1st block in 50th reduction), 3 votes, use VGLP0010",
		params:       mockMainNetParams,
		height:       307200,
		numVotes:     3,
		variant:      SSVVGLP0010,
		...
		name:         "height 307200 (1st block in 50th reduction), 3 votes, use VGLP0012",
		params:       mockMainNetParams,
		height:       307200,
		numVotes:     3,
		variant:      SSVVGLP0012,
		...
		name:         "height 10401792 (first zero work subsidy with VGLP0012 1693rd reduction), 5 votes",
		params:       mockMainNetParams,
		height:       10401792,
		numVotes:     5,
		variant:      SSVVGLP0012,
		...
		name:         "height 10954752 (first zero work subsidy with VGLP0010 1783rd reduction), 5 votes",
		params:       mockMainNetParams,
		height:       10954752,
		numVotes:     5,
		variant:      SSVVGLP0010,
		...
		name:         "height 10973184 (first zero vote subsidy with VGLP0010 1786th reduction), 5 votes",
		params:       mockMainNetParams,
		height:       10973184,
		numVotes:     5,
		variant:      SSVVGLP0010,
		...
		name:         "height 10979328 (first zero vote subsidy with VGLP0012 1787th reduction), 5 votes",
		params:       mockMainNetParams,
		height:       10979328,
		numVotes:     5,
		variant:      SSVVGLP0012,
		...
		name:         "height 11010048 (first zero full subsidy 1792nd reduction), 5 votes, use VGLP0010",
		params:       mockMainNetParams,
		height:       11010048,
		numVotes:     5,
		variant:      SSVVGLP0010,
		...
		name:         "height 11010048 (first zero full subsidy 1792nd reduction), 5 votes, use VGLP0012",
		params:       mockMainNetParams,
		height:       11010048,
		numVotes:     5,
		variant:      SSVVGLP0012,
...
// TestTotalSubsidyVGLP0010 ensures the estimated total subsidy produced with the
// subsidy split defined in VGLP0010 matches the expected value.
func TestTotalSubsidyVGLP0010(t *testing.T) {
	// Locals for convenience.
	mockMainNetParams := mockMainNetParams()
	reductionInterval := mockMainNetParams.SubsidyReductionIntervalBlocks()
	stakeValidationHeight := mockMainNetParams.StakeValidationBeginHeight()
	...
	// defined in VGLP0010.  Note that this value is not exactly the same as the
	// full subsidy originally used to calculate the individual proportions due
	// to the use of integer math.
	cache := NewSubsidyCache(mockMainNetParams)
	subsidySum := func(height int64, useVGLP0010 bool) int64 {
		work := cache.CalcWorkSubsidyV2(height, votesPerBlock, useVGLP0010)
		vote := cache.CalcStakeVoteSubsidyV2(height, useVGLP0010) *
			int64(votesPerBlock)
	...
	for reductionNum := int64(0); ; reductionNum++ {
		...
		// which VGLP0010 should be activated is impossible to know at the time
		...
		// interval on mainnet.
		subsidyCalcHeight := reductionNum * reductionInterval
		useVGLP0010 := subsidyCalcHeight >= reductionInterval*104
		sum := subsidySum(subsidyCalcHeight, useVGLP0010)
		if sum == 0 {
			break
		}
		totalSubsidy += sum * reductionInterval
...
// TestTotalSubsidyVGLP0012 ensures the estimated total subsidy produced with the
// subsidy split defined in VGLP0012 matches the expected value.
func TestTotalSubsidyVGLP0012(t *testing.T) {
	// Locals for convenience.
	mockMainNetParams := mockMainNetParams()
	reductionInterval := mockMainNetParams.SubsidyReductionIntervalBlocks()
	stakeValidationHeight := mockMainNetParams.StakeValidationBeginHeight()
	...
	// changes.
	//
	// VGLP0010ActivationHeight is the height when the subsidy split change
	// defined in VGLP0010 activated on the main network.
	//
	// estimatedVGLP0012ActivationHeight is necessarily an estimate since the
	// exact height at which VGLP0012 should be activated is impossible to know
	// at the time of this writing.  For testing purposes, the activation height
	// is estimated to be 782208 on mainnet.
	const VGLP0010ActivationHeight = 657280
	const estimatedVGLP0012ActivationHeight = 782208
	subsidySplitChanges := map[int64]struct {
		activationHeight int64
		splitBefore      SubsidySplitVariant
		splitAfter       SubsidySplitVariant
	}{
		VGLP0010ActivationHeight / reductionInterval: {
			activationHeight: VGLP0010ActivationHeight,
			splitBefore:      SSVOriginal,
			splitAfter:       SSVVGLP0010,
		},
		estimatedVGLP0012ActivationHeight / reductionInterval: {
			activationHeight: estimatedVGLP0012ActivationHeight,
			splitBefore:      SSVVGLP0010,
			splitAfter:       SSVVGLP0012,
		},
	}
	...
	for reductionNum := int64(0); ; reductionNum++ {
		...
		switch {
		case subsidyCalcHeight >= estimatedVGLP0012ActivationHeight:
			splitVariant = SSVVGLP0012
		case subsidyCalcHeight >= VGLP0010ActivationHeight:
			splitVariant = SSVVGLP0010
		}
