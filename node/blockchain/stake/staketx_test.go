...
func TestSStx(t *testing.T) {
	var sstx = VGLutil.NewTx(sstxMsgTx)
	...
	sstx = VGLutil.NewTxDeep(sstxMsgTx)
...
func TestSSTxErrors(t *testing.T) {
	...
	var sstxExtraInputs = VGLutil.NewTx(sstxMsgTxExtraInput)
	...
	var sstxExtraOutputs = VGLutil.NewTx(sstxMsgTxExtraOutputs)
	...
	var sstxUntaggedOut = VGLutil.NewTx(&tx)
	...
	var sstxInsOutsMismatched = VGLutil.NewTx(sstxMismatchedInsOuts)
	...
	var sstxBadVerOut = VGLutil.NewTx(sstxBadVersionOut)
	...
	var sstxNoNullData = VGLutil.NewTx(sstxNullDataMissing)
	...
	var sstxNullDataMis = VGLutil.NewTx(sstxNullDataMisplaced)
	...
	var sstxWrongPKHLength = VGLutil.NewTx(&tx)
	...
	var sstxWrongPrefix = VGLutil.NewTx(&tx)
...
func TestSSGen(t *testing.T) {
	var ssgen = VGLutil.NewTx(ssgenMsgTx)
	...
	ssgen = VGLutil.NewTxDeep(ssgenMsgTx)
	ssgen.SetTree(wire.TxTreeStake)
	ssgen.SetIndex(0)
...
func TestSSGenErrors(t *testing.T) {
	...
	var ssgenExtraInputs = VGLutil.NewTx(ssgenMsgTxExtraInput)
	...
	var ssgenExtraOutputs = VGLutil.NewTx(ssgenMsgTxExtraOutputs)
	...
	var ssgenStakeBaseWrong = VGLutil.NewTx(ssgenMsgTxStakeBaseWrong)
	...
	var ssgenWrongTreeIns = VGLutil.NewTx(&tx)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssgenTxBadVerOut = VGLutil.NewTx(ssgenMsgTxBadVerOut)
	...
	var ssgenWrongZeroethOut = VGLutil.NewTx(ssgenMsgTxWrongZeroethOut)
	...
	var ssgenWrongDataPush0Length = VGLutil.NewTx(&tx)
	...
	var ssgenWrongNullData0Prefix = VGLutil.NewTx(&tx)
	...
	var ssgenWrongFirstOut = VGLutil.NewTx(ssgenMsgTxWrongFirstOut)
	...
	var ssgenWrongDataPush1Length = VGLutil.NewTx(&tx)
	...
	var ssgenWrongNullData1Prefix = VGLutil.NewTx(&tx)
	...
	var ssgentestGenOutputUntagged = VGLutil.NewTx(&tx)
	...
	var ssgenNoDiscriminator = VGLutil.NewTx(ssgenMsgTxNoDiscriminator)
	...
	var ssgenInvalidDiscriminator = VGLutil.NewTx(ssgenMsgTxInvalidDiscriminator)
	...
	var ssgenInvalidDiscriminator2 = VGLutil.NewTx(ssgenMsgTxUnknownDiscriminator)
	...
	var ssgenInvalidDiscriminator3 = VGLutil.NewTx(ssgenMsgTxUnknownDiscriminator2)
	...
	var ssgenInvalidTVNoVote = VGLutil.NewTx(ssgenMsgTxInvalidTV)
	...
	var ssgenInvalidTVNoVote2 = VGLutil.NewTx(ssgenMsgTxInvalidTV2)
	...
	// and a short vote.
	var ssgenInvalidTVNoVote3 = VGLutil.NewTx(ssgenMsgTxInvalidTV3)
	...
	// and a short vote.
	var ssgenInvalidTVNoVote4 = VGLutil.NewTx(ssgenMsgTxInvalidTV4)
	...
	var ssgenInvalidTVNoVote5 = VGLutil.NewTx(ssgenMsgTxInvalidTV5)
	...
	var ssgenInvalidTVote = VGLutil.NewTx(ssgenMsgTxInvalidTVote)
	...
	var ssgenInvalidTVote2 = VGLutil.NewTx(ssgenMsgTxInvalidTVote2)
	...
	var ssgenInvalidTVote3 = VGLutil.NewTx(ssgenMsgTxInvalidTVote3)
...
func TestSSGenTreasuryVotes(t *testing.T) {
	var ssgenValidVote = VGLutil.NewTx(ssgenMsgTxValid)
...
func TestCreateRevocationFromTicket(t *testing.T) {
	...
	revocationTxFee := VGLutil.Amount(285000)
	...
	autoRevocationsTxFee := VGLutil.Amount(0)
	...
	tests := []struct {
		...
		ticketMinOuts            []*MinimalOutput
		revocationTxFee          VGLutil.Amount
