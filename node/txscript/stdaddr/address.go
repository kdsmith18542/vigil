// Copyright (c) 2021-2023 The Vigil developers
// Use of this source code is governed by an ISC
// license that can be found in the LICENSE file.

// Package stdaddr provides facilities for working with human-readable Vigil
// payment addresses.
package stdaddr
...
// EC-Schnorr-VGL signature for a specific secp256k1 public key.
//
// The provided public key MUST be a valid secp256k1 public key serialized in
// the _compressed_ format or an error will be returned.
//
...
// destination which imposes an encumbrance that requires a valid EC-Schnorr-VGL
// signature for a specific secp256k1 public key.
//
...
// hash along with a valid EC-Schnorr-VGL signature for that public key.
//
// For version 0 scripts, the provided public key hash must be 20 bytes and is
// expected to be the Hash160 of the associated secp256k1 public key serialized
// in the _compressed_ format.
...
// runes in the base58 alphabet used by Vigil for version 0 addresses.
func probablyV0Base58Addr(s string) bool {
	...
	// The modified base58 alphabet used by Vigil for version 0 addresses is:
