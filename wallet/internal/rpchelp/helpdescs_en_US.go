...
var helpDescsEnUS = map[string]string{
	...
	"createrawtransaction-amounts--desc":  "The destination address as the key and the amount in VGL as the value",
	...
	"debuglevel--synopsis": "Dynamically changes the debug logging level.\n" +
		...
		"The valid subsystems are CMGR, VGLW, GRPC, LODR, MIXC, MIXP, PEER, RPCS, SYNC, TKBY, VSPC, and WLLT.\n" +
	...
	"getblockheaderverboseresult-powhash":           "The Proof-of-Work hash of the block (same as hash prior to VGLP0011 activation)",
	...
	"getblock-verbosetx":   "Specifies that each transaction is returned as a JSON object and only applies if the verbose flag is true (vgld extension)",
	...
	"getblockverboseresult-powhash":           "The Proof-of-Work hash of the block (same as hash prior to VGLP0011 activation)",
	...
	"scriptpubkeyresult-addresses": "The Vigil addresses associated with this script",
	...
	"getcurrentnet--synopsis": "Get Vigil network the wallet is connected to.",
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in Vigil",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in Vigil",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in Vigil",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in Vigil.",
	...
	"getwalletfee--result0":  "Current tx fee (in VGL)",
	...
	"gettxoutresult-value":         "The transaction amount in VGL",
	...
	"inforesult-relayfee":        "The minimum relay fee for non-free transactions in VGL/KB",
	...
	"listaccounts--result0--desc":  "JSON object with account names as keys and Vigil amounts as values",
	"listaccounts--result0--key":   "The account name",
	"listaccounts--result0--value": "The account balance valued in Vigil",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in Vigil",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in Vigil",
	...
	"listtransactionsresult-amount":            "The value of the transaction output valued in Vigil",
	...
	"listunspentresult-amount":        "The amount of the output valued in Vigil",
	...
	"sendfrom-amount":      "Amount to send to the payment address valued in Vigil",
	...
	"sendfromtreasury-key":            "Vigiliteia public key",
	"sendfromtreasury-amounts":        "Pairs of payment addresses and the output amount to pay each",
	"sendfromtreasury-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in Vigil to send to each address",
	"sendfromtreasury-amounts--key":   "Address to pay",
	"sendfromtreasury-amounts--value": "Amount to send to the payment address valued in Vigil",
	...
	"sendmany-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in Vigil to send to each address",
	"sendmany-amounts--key":   "Address to pay",
	"sendmany-amounts--value": "Amount to send to the payment address valued in Vigil",
	...
	"sendtoaddress-amount":    "Amount to send to the payment address valued in Vigil",
	...
	"sendtomultisig-amount":      "Amount to send to the payment address valued in Vigil",
	"sendtomultisig-comment":     "Unused",
	"sendtomultisig--result0":    "The transaction hash of the sent transaction",

	// SendToTreasuryCmd help.
	"sendtotreasury--synopsis": "Send Vigil to treasury",
	...
	"setticketmaxprice-max":       "The max price (in VGL).",
	...
	"settxfee-amount":    "The new fee per kB of the serialized tx size valued in Vigil",
	...
	// ValidatePreVGLP0005CFCmd help
	"validatepreVGLP0005cf--synopsis": "Validate whether all stored cfilters from before VGLP0005 activation are correct according to the expected hardcoded hash",
	"validatepreVGLP0005cf--result0":  "Whether the cfilters are valid",
