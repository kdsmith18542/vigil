...
// Currently, vglwallet is in the process of converting to the new Go 1.13 error
// wrapping features.
...
const (
	...
	NoPeers                         // Vigil network is unreachable due to lack of peers or vgld RPC connections
...
func (k Kind) String() string {
	...
	case NoPeers:
		return "Vigil network is unreachable"
	case Deployment:
