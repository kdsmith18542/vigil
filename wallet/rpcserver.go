...
func generateRPCKeyPair(writeKey bool) (tls.Certificate, error) {
	...
	// Generate cert pair.
	org := "vigilwallet autogenerated cert"
...
func generateAuthority(pub, priv any) (*ClientCA, error) {
	...
	template := &x509.Certificate{
		...
		Subject: pkix.Name{
			CommonName:         "vigilwallet",
			Organization:       []string{"vigilwallet"},
			OrganizationalUnit: []string{"vigilwallet certificate authority"}
		},
...
func createSignedClientCert(pub, caPriv any, ca *x509.Certificate) ([]byte, error) {
	...
	template := &x509.Certificate{
		...
		Subject: pkix.Name{
			CommonName:         "vigilwallet",
			Organization:       []string{"vigilwallet"}
			OrganizationalUnit: []string{"vigilwallet client certificate"}
		},
	}
