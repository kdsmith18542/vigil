...
var (
	certFile = filepath.Join(VGLutil.AppDataDir("vglwallet", false), "rpc.cert")
...
func connectWallet(host, user, pass, certFile string) (*vglwallet.Client, error) {
	...
	return vglwallet.NewClient(vglwallet.RawRequestCaller(client), params), nil
}
