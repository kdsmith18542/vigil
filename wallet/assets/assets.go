...
// Path returns the absolute filepath of a file in the vglwallet main module,
// relative to the assets package.
//
// For example, to access the filepath of a sample-vglwallet.conf file from the
// root of the main module, call Path("../sample-vglwallet.conf").
//
