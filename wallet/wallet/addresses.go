...
type stakeAddress interface {
	...
	rewardCommitment(amount VGLutil.Amount, limits uint16) (script []byte, version uint16)
...
func (x *xpubAddress) rewardCommitment(amount VGLutil.Amount, limits uint16) ([]byte, uint16) {
	s := make([]byte, 32)
