...
type InputSource func(target VGLutil.Amount) (detail *InputDetail, err error)
...
func NewUnsignedTransaction(outputs []*wire.TxOut, relayFeePerKb VGLutil.Amount,
